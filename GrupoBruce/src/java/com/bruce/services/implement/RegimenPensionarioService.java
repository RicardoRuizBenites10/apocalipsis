...
public class RegimenPensionarioService implements IRegimenPensionarioService{
    ...
    @Override
    public RegimenPensionario lastByFilter(String filter, String query) {
        ObjectMapper mapper = new ObjectMapper();
        List<FilterPage> filters = new ArrayList<>();
        try {
            if (filter != null) {
    ...
    @Override
    public List<RegimenPensionario> getByFilter(int start, int limit, String sort, String filter, String query) {
        ObjectMapper mapper = new ObjectMapper();
