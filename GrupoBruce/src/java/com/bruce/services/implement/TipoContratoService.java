...
public class TipoContratoService implements ITipoContratoService{
    ...
    @Override
    @Transactional
    public TipoContrato lastByFilter(String filter, String query) {
        ObjectMapper mapper = new ObjectMapper();
        List<FilterPage> filters = new ArrayList<>();
        try {
            if (filter != null) {
    ...
    @Override
    @Transactional
    public List<TipoContrato> getByFilter(int start, int limit, String sort, String filter, String query) {
        ObjectMapper mapper = new ObjectMapper();
