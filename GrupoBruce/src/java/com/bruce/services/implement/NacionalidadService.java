...
public class NacionalidadService implements INacionalidadService{
    ...
    @Override
    @Transactional
    public Nacionalidad lastByFilter(String filter, String query) {
        ObjectMapper mapper = new ObjectMapper();
        List<FilterPage> filters = new ArrayList<>();
        try {
            if (filter != null) {
    ...
    @Override
    @Transactional
    public List<Nacionalidad> getByFilter(int start, int limit, String sort, String filter, String query) {
        ObjectMapper mapper = new ObjectMapper();
