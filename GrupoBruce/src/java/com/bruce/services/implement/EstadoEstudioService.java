...
public class EstadoEstudioService implements IEstadoEstudioService{
    ...
    @Override
    public EstadoEstudio lastByFilter(String filter, String query) {
        ObjectMapper mapper = new ObjectMapper();
        List<FilterPage> filters = new ArrayList<>();
        try {
            if (filter != null) {
    ...
    @Override
    public List<EstadoEstudio> getByFilter(int start, int limit, String sort, String filter, String query) {
        ObjectMapper mapper = new ObjectMapper();
