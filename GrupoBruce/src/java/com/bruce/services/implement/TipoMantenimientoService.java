...
public class TipoMantenimientoService implements ITipoMantenimientoService{
    ...
    @Override
    @Transactional
    public List<TipoMantenimiento> getByFilter(int start, int limit, String sort, String filter, String query) {
    ...
    @Override
    @Transactional
    public TipoMantenimiento lastByFilter(String filter, String query) {
        ObjectMapper mapper = new ObjectMapper();
        List<FilterPage> filters = new ArrayList<>();
        try {
            if (filter != null) {
