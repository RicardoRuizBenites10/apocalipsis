 ...
 */
@Service
public class ObraTipoService implements IObraTipoService {

    @Autowired
    private IObraTipoDAO dao;

    @Override
    @Transactional
    public void insert(ObraTipo t) {
        dao.create(t);
    }
    ...
    @Override
    @Transactional
    public ObraTipo find(Object id) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    @Transactional
    public ObraTipo lastByFilter(String filter, String query) {
        ObjectMapper mapper = new ObjectMapper();
        List<FilterPage> filters = new ArrayList<>();
        try {
            if (filter != null) {
    ...
    @Override
    @Transactional
    public List<ObraTipo> getByFilter(int start, int limit, String sort, String filter, String query) {
        ObjectMapper mapper = new ObjectMapper();
