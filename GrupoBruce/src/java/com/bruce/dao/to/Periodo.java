...
public class Periodo  implements java.io.Serializable {
    ...
    public Periodo(int idPeriodo, Date inicio, Date fin, boolean situacion, boolean cerrado, int idTperiodo) {
    ...
    public Periodo(int idPeriodo, Date inicio, Date fin, Date iniPlame, Date finPlame, boolean situacion, boolean cerrado, int idTperiodo, Integer idTtrabajador) {
       this.idPeriodo = idPeriodo;
       this.inicio = inicio;
       this.fin = fin;
    ...
    @Column(name="ID_TPERIODO", nullable=false)
