...
public class ObraDAO implements IObraDAO{
    ...
    public Obra lastByFilter(List<FilterPage> filters) {
        ...
        reverse.addJoin("LEFT JOIN OBRA_SEGUIMIENTO OS", "OS.ID_OBRA= O.ID_OBRA AND OS.ID_EPROCESO=O.ID_EPROCESO");
        reverse.addJoin("LEFT JOIN ETAPA_PROCESO EP", "EP.ID_EPROCESO=OS.ID_EPROCESO");
