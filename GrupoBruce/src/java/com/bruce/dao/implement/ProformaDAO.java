...
public class ProformaDAO implements IProformaDAO {
    ...
    public Proforma lastByFilter(List<FilterPage> filters) {
        ...
        reverse.addResult("PR.ANIO");
        reverse.addResult("PR.FECHA_INSERT");
        reverse.addResult("PR.FECHA_UPDATE");
        reverse.addResult("PR.SITUACION");
        reverse.addResult("PR.ID_CARROCERIA");
        reverse.addResult("PR.ID_CLIENTE");
        reverse.addResult("PR.USU_INSERT");
        reverse.addResult("PR.USU_UPDATE");
