...
public class TipoDocumentoDAO implements ITipoDocumentoDAO {
    ...
    @Override
    public List<TipoDocumento> getByFilter(int start, int limit, List<SortPage> sorts, List<FilterPage> filters) {
        Session session = sf.getCurrentSession();
        Criteria cr = session.createCriteria(TipoDocumento.class);
        if(filters!=null){
    ...
    @Override
    public TipoDocumento get(Object idT) {
    ...
    @Override
    public TipoDocumento lastByFilter(List<FilterPage> filters) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
