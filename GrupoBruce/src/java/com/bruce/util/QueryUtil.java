...
public class QueryUtil {
    ...
    //ACCESO
    public static final String ACCESO_ROL = "SELECT M.ID_MENU, :IDROL ID_ROL, ISNULL(A.FECHA_UPDATE,GETDATE()) FECHA_UPDATE, ISNULL(A.ACCEDER, 0) AS ACCEDER , M.DESCRIPCION text, M.LEAF, M.ID_SUPMENU idSupmenu, M.ICON_CLS iconCls, M.ACCION handler FROM MENU M LEFT JOIN ACCESO A ON A.ID_MENU = M.ID_MENU AND A.ID_ROL=:IDROL";
