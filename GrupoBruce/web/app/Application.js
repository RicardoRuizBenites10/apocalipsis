Ext.define('GrupoBruce.Application', {
    ...
    stores: [
        ...
        'GrupoBruce.store.ColorDiseno',
        'GrupoBruce.store.ColorFormula',
        ...
        'GrupoBruce.store.ObraContratista',
        'GrupoBruce.store.ObraPintura',
        'GrupoBruce.store.ObraSeguimiento',
